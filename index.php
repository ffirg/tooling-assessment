...
<nav class="navbar navbar-default" role="navigation">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="assess.php"><img src="images/innovate.png">  Management Tooling</a>
		</div>
...
<p>Guidance for scoring: ...</p>
<p><label>Comments: </label><input type="text" name="d3-text"></p>
  </fieldset>

  <fieldset>
    <p><b>Future Position (0-10): </b><input type="number" name="o3" min="0" max="10"></p>
<p>Guidance for scoring: ...</p>
<p><label>Comments: </label><input type="text" name="o3-text"></p>
  </fieldset>
  </div>
...
<p>Guidance for scoring: ...</p>
<p><label>Comments: </label><input type="text" name="d6-text"></p>
  </fieldset>

  <fieldset>
    <p><b>Future Position (0-10): </b><input type="number" name="o6" min="0" max="10"></p>
<p>Guidance for scoring: ...</p>
<p><label>Comments: </label><input type="text" name="o6-text"></p>
  </fieldset>
  </div>
...
<p>Guidance for scoring: ...</p>
<p><label>Comments: </label><input type="text" name="d7-text"></p>
  </fieldset>

  <fieldset>
    <p><b>Future Position (0-10): </b><input type="number" name="o7" min="0" max="10"></p>
<p>Guidance for scoring: ...</p>
<p><label>Comments: </label><input type="text" name="o7-text"></p>
  </fieldset>
  </div>
...
<p>Guidance for scoring: ...</p>
<p><label>Comments: </label><input type="text" name="d8-text"></p>
  </fieldset>

  <fieldset>
    <p><b>Future Position (0-10): </b><input type="number" name="o8" min="0" max="10"></p>
<p>Guidance for scoring: ...</p>
<p><label>Comments: </label><input type="text" name="o8-text"></p>
  </fieldset>
  </div>
...
<p>Guidance for scoring: ...</p>
<p><label>Comments: </label><input type="text" name="d11-text"></p>
  </fieldset>

  <fieldset>
    <p><b>Future Position (0-10): </b><input type="number" name="o11" min="0" max="10"></p>
<p>Guidance for scoring: ...</p>
<p><label>Comments: </label><input type="text" name="o11-text"></p>
  </fieldset>
  </div>
...
<p>Guidance for scoring: ...</p>
<p><label>Comments: </label><input type="text" name="d2-text"></p>
  </fieldset>

  <fieldset>
    <p><b>Future Position (0-10): </b><input type="number" name="o2" min="0" max="10"></p>
<p>Guidance for scoring: ...</p>
<p><label>Comments: </label><input type="text" name="o2-text"></p>
  </fieldset>
  </div>
...
<p>Guidance for scoring: ...</p>
<p><label>Comments: </label><input type="text" name="d9-text"></p>
  </fieldset>

  <fieldset>
    <p><b>Future Position (0-10): </b><input type="number" name="o9" min="0" max="10"></p>
<p>Guidance for scoring: ...</p>
<p><label>Comments: </label><input type="text" name="o9-text"></p>
  </fieldset>
  </div>
...
<p>Guidance for scoring: ...</p>
<p><label>Comments: </label><input type="text" name="d10-text"></p>
  </fieldset>

  <fieldset>
    <p><b>Future Position (0-10): </b><input type="number" name="o10" min="0" max="10"></p>
<p>Guidance for scoring: ...</p>
<p><label>Comments: </label><input type="text" name="o1-text"></p>
  </fieldset>
  </div>
...
<p>Guidance for scoring: ...</p>
<p><label>Comments: </label><input type="text" name="d1-text"></p>
  </fieldset>
